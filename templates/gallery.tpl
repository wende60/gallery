REX_TEMPLATE[2]
    ...
    <?php
        ...
        if(
            ...
            $fragmentImgData  =  $GLOBALS['gfxdata'][$escapedFragment];
        }

        if(OOAddon::isAvailable('yrewrite')) {
            $view_url = "/imagetypes/" . $fragmentImgData['view'] . "/" . $fragmentImgData['gfx'];
        } else {
            $view_url = "/index.php?rex_img_type=" . $fragmentImgData['view'] . "&rex_img_file=" . $fragmentImgData['gfx'];
        }
    ?>
    ...
    <div id="viewimage-wrapper" class="viewimage-wrapper">
        ...
        <ul id="viewimage-wrapper-list">
            ...
            <li>
                <span></span>
                <?php if($escapedFragment) { ?>
                    <img id="gallery-view-img-2" alt="<?php echo addslashes($fragmentImgData['title']) ?>" src="<?php echo $view_url ?>">
